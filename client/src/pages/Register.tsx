    ...
    <div className="min-h-[calc(100vh-4rem)] flex animate-fade-in">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-surface-50 dark:bg-[#0f1117]">
        <div className="w-full max-w-md">
              ...
              <div key={label} className="flex items-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className={`mt-1.5 text-2xs font-medium ${
                    i <= currentStep ? 'text-uhp-600 dark:text-uhp-400' : 'text-surface-400'
                  }`}>
                    {label}
                  </span>
                </div>
                {i < stepLabels.length - 1 && (
                  <div className={`w-16 sm:w-24 h-0.5 mx-2 mb-5 transition-colors duration-300 ${
                    i < currentStep ? 'bg-uhp-600' : 'bg-surface-200 dark:bg-surface-700'
                  }`} />
                )}
              </div>
            ))}
          ...
          <Card padding="lg">
            <h2 className="text-2xl font-bold text-surface-900 dark:text-white mb-2">Register Handle</h2>
            ...
            <p className="mt-6 text-center text-sm text-surface-500 dark:text-surface-400">
              ...
              <Link to="/login" className="text-uhp-600 dark:text-uhp-400 hover:text-uhp-700 dark:hover:text-uhp-300 font-medium">
                Login here
              </Link>
            </p>
          </Card>
